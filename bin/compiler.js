    ...
    function getTokens(source, last) {
        ...
        switch (source.charAt(0)) {
            ...
            case '"':
                ...
                if (index === -1) {
                    numWarns++;
                    Log.LexMsg("Unclosed String literal", lineNum, charNum, LogPri.WARNING, "Adding closing quote...");
                    str = source.substr(0) + '"';
                ...
                if (/^[a-z" ]*$/.test(str)) {
                    ...
                    numErrors++;
                    Log.LexMsg("String literal '" + str + "' contains invalid characters", lineNum, charNum, LogPri.ERROR, "Strings can only contain lowercase letters and spaces.");
                    charNum += numCols;
                    lineNum += numLines;
